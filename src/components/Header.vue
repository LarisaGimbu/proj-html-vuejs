<template>
  <header>
    <div class="container">
      <div class="header-top d-flex justify-content-between align-intems-center">
        <ul >
          <li class="pe-3"><a href="#">Download App</a></li>
        ...
        <ul>
          ...
          :key="index"
          class="pe-3"><a href="#"><i :class="`fab fa-${item}`"></i></a></li>
        </ul>
      </div>
